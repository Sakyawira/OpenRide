...
| -------------------------------- | ------------------- | --------------------------------- |
| Persistence and atomic event log | BookingRepository   | BookingStore / PGlite             |
...
The simulated provider has its own PGlite database. Real providers implement the protocol against their own dispatch and storage systems.
